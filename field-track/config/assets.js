...
export const backgroundAssets = {
    cloud_1: {
        ...
        width: boardWidth * SCALE.SMALL_CLOUD_WIDTH_RATIO,
        get height() {
            return this.width * SCALE.SMALL_CLOUD_ASPECT_RATIO / 1.5 + Math.random();
        },
        speed: 3.5,
        probability: 0.1
    },
