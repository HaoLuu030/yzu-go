...
export const obstacleAssets = {
    cone: {
        ...
        get height() { return this.width * SCALE.CONE_ASPECT_RATIO; },
        speed: 4,
        isAnimated: false,
        probability: 0.2,
    },
    ...
    shiba: {
        ...
        get height() { return this.width * SCALE.SHIBA_ASPECT_RATIO; },
        speed: 6,
        isAnimated: true,
        probability: 0.3,
    },
    ...
    corgi: {
        ...
        get height() { return this.width * SCALE.CORGI_ASPECT_RATIO; },
        speed: 4,
        isAnimated: true,
        probability: 0.4,
    },
    ...
    dave: {
        ...
        get height() { return this.width * SCALE.HUMAN_ASPECT_RATIO; },
        speed: 6,
        isAnimated: true,
        probability: 0.45,
    },
    ...
    basket_ball: {
        ...
        get height() { return this.width * SCALE.CART_ASPECT_RATIO; },
        speed: 4,
        isAnimated: false,
        probability: 0.8,
    },
    ...
    hurdle: {
        ...
        get height() { return this.width * SCALE.HURDLE_ASPECT_RATIO; },
        speed: 4,
        isAnimated: false,
        probability: 0.95,
    },
    ...
    cycling_man: {
        ...
        get height() { return this.width * SCALE.CYLING_MAN_ASPECT_RATIO; },
        speed: 8,
        isAnimated: true,
        probability: 1,
    }
...
//         get height() { return this.width * SCALE.GOAL_POST_ASPECT_RATIO; },
//         speed: 3,
//         probability: 0.5
//     },
...
export const backgroundAssets = {
    cloud_1: {
        ...
        get height() { return this.width * SCALE.BIG_CLOUD_ASPECT_RATIO; },
        speed: 3.5,
        probability: 0.2
    },
    cloud_2: {
    ...
    cloud_4: {
        ...
        get height() { return this.width * SCALE.MID_CLOUD_ASPECT_RATIO; },
        speed: 3.5,
        probability: 0.8
    },
    cloud_6: {
