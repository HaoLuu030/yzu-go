    ...
    postLevel: {
        ...
        level4: {
            ...
            lines: {
                low: [
                    "Out already?",
                    "Honestly, that’s about what I expected. Throw in a rumor and people stop thinking immediately.",
                    "Anyway, I’m exhausted from all that moving around.",
                    "Let's get back to the brainy stuff shall we?",
                    "Out already?",
                    "Honestly, that’s about what I expected. People fall for nonsense rumors like this all the time.",
